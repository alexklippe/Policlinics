...
Public Class EmailService
    ...
    Public Function SendAsync(message As IdentityMessage) As Task Implements IIdentityMessageService.SendAsync
        ...
        'Dim org = From p In db.Organization Where p.OrgDomainName = "sp1taganrog.ru"
        Dim org = (From p In db.Organization Where p.id = 7 Select p).First
        ...
        Dim myMessage = New System.Net.Mail.MailMessage

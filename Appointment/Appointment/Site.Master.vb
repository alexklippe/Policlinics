...
Public Class SiteMaster
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '    Return
        'End If
        'If User.IsInRole("PolicAdmins") Then
        '    Me.Panel1.Visible = False
        ...
        Not Me.Request.Url.DnsSafeHost = "localhost" Then
            ...
            End If
            Response.Redirect("https://" + Me.Request.Url.DnsSafeHost.ToString + "/" + Request.Url.PathAndQuery.ToString)
        End If
        ...
        Else   ''основной
            ...
            Me.LiteralBackStretch.Text = "<script src=""../js/jquery.backstretch.js"" type=""text/javascript""></script>" + _
                              " <script type=""text/javascript"">" + _
                               "'use strict';" + _
                      "   $.backstretch([""../img/34.jpg""], {duration: 300000, fade: 200  }    );    </script>"

Public Class stat1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            TextBox1.Text = "1." + Now.AddMonths(-1).Month.ToString + "." + Now.AddMonths(-1).Year.ToString
            TextBox2.Text = DateTime.DaysInMonth(Now.AddMonths(-1).Year, Now.AddMonths(-1).Month).ToString + "." + Now.AddMonths(-1).Month.ToString + "." + Now.AddMonths(-1).Year.ToString
        End If
    ...
    Protected Sub Generate()
        ...
        Literal1.Text += "<br />Всего подтверждено по филиалам: " + "<br />"
        For Each row In query4
            Literal1.Text += row.filialName.ToString + ": " + row.Total.ToString + "<br />"
        Next
        'Total fils declined
        ...
        Literal1.Text += "<br />Всего отказано по филиалам: " + "<br />"
        For Each row In query4
            Literal1.Text += row.filialName.ToString + ": " + row.Total.ToString + "<br />"
        Next
    End Sub
